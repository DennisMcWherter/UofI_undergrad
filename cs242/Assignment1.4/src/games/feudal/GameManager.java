...
public class GameManager {
	public final static int MAX_ARMIES = 2;
	 ...
	 * 			(returns whole list of pieces eliminated) otherwise return null
	 */
	public List<Piece> completeTurn(List<Piece> thePieces) {
		if(thePieces == null)
			return null;
