...
public class PuzzlesController implements ActionListener {
	 ...
	 */
	public PuzzlesController(PuzzlesModel model, MainGuiView view) {
		this.model = model;
		this.view  = view;
	}
	...
	public void actionPerformed(ActionEvent ae) {
		...
		if(what.equalsIgnoreCase("Exit"))
			System.exit(0);
		else if(what.equalsIgnoreCase("Help"))
			displayHelp();
		else if(what.equalsIgnoreCase("About"))
			displayAbout();
	}
